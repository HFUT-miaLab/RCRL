...
if __name__ == "__main__":
    ...
    parser.add_argument('--features_root', type=str,
                        default=r'E:\qq\TCGA-EGFR\TCGA_EGFR_slide_feat_PLIP',help='patches feature save dir')
    parser.add_argument('--report_features_root', type=str,
                        default=r'E:\qq\TCGA-EGFR\TCGA-EGFR-diagnosis-clean1-feature-PLIP',help='histopathological report feature save dir')
    parser.add_argument('--report_tokens_features_root', type=str,
                        default=r'E:\qq\TCGA-EGFR\TCGA-EGFR-diagnosis-clean1-tokens-feature-PLIP',help='word tokens of histopathological report save dir')
    parser.add_argument('--sequence_features_root', type=str,
                        default=r'E:\qq\TCGA-EGFR\TCGA-EGFR-sequence-feature-PLIP',help='gene sequencing report feature save dir')
