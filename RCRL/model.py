...
class RCRL(nn.Module):
    def __init__(self, n_classes, max_length = 4):
        ...
        self.fc_image = nn.Sequential(nn.Linear(384, 512), nn.ReLU())
        self.fc_histo_tokens = nn.Sequential(nn.Linear(768, 512), nn.ReLU())
        self.fc_histo = nn.Sequential(nn.Linear(768, 512), nn.ReLU())
        self.fc_gene = nn.Sequential(nn.Linear(768, 512), nn.ReLU())
